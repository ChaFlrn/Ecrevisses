...
### Processed_data
Fichiers de données enregistrés durant les différents traitements et analyses de données, sous format RData.
...
- 01_importation_data_fauna : instruction pour importation et traitement du jeu de données FAUNA
- 01_importation_data_oison : insctruction pour importation et traitement du jeu de données OISON
- 02_assemblage_bases : insctructions pour assemblage des bases et nettoyage de la base de données finale
