...
- Vérification des doublons : dans les deux bases initiales des doublons ont été observés, 4 pour FAUNA et 51 pour OISON.
...
tablo_synt_esp <- bdd_ecrevisse %>%
  ...
  group_by(Cdnom, Nom_vernaculaire, Nom_scientifique) %>%
