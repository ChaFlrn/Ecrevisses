...
subtitle: "Données ASPE, ASTAQUITAINE, FAUNA, NAIADES et OISON"
...
tablo_data <- data.frame(
  Base = c("ASPE", "ASTAQUITAINE","FAUNA","NAIADES","OISON"),
  Donnees_brutes = c(nrow(data_aspe), nrow(data_astaq), nrow(data_fauna), nrow(data_naiades),nrow(data_oison)),
