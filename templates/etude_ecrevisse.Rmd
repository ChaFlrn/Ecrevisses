...
tablo_data <- data.frame(
  ...
  Donnees_traitees = c(3567,40366,43909),
...
cartes_162666 <- (carte_162666_2005 | carte_162666_2015 | carte_162666_2025) +
  plot_annotation(
    theme = theme(
      plot.title = element_text(size = 14),
      plot.subtitle = element_text(size = 8)
